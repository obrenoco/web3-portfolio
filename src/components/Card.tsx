...
export const Card = ({ title }: { title: string }) => (
  <div className="border-y-[1px] border-gray-700 px-6 py-10 text-4xl flex items-center justify-between font-bold hover:bg-gray-800 hover:border-transparent transition-all duration-200 group cursor-pointer fadeIn">
    <p>
      {title}{" "}
